  ...
  return (
    ...
    >
      ...
      <div className="mt-12 text-center ">
        <p className="text-base md:text-xl font-bold">MAY 2025</p>
        <div className="grid grid-cols-7 gap-2 text-sm md:text-base mt-4">
            ...
            .map((_, i) => {
              ...
              return day === 18 ? (
                ...
                >
                  ...
                  {/* Số ngày */}
                  <span className="text-white font-bold z-10 text-[10px] md:text-[12px]">
                    {day}
                  </span>
                </motion.span>
              ) : (

...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="min-h-screen flex flex-col items-center justify-end hero-bg relative pb-10 sm:pb-14 lg:pb-16"
    >
      {/* Lớp phủ sáng phía dưới — chữ dễ đọc, khớp theme */}
      <div className="absolute inset-x-0 bottom-0 top-[25%] bg-gradient-to-t from-[var(--wedding-bg)] via-[rgba(253,248,248,0.92)] to-transparent pointer-events-none" aria-hidden />
